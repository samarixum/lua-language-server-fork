...
local getName      = require("script.core.hover.name")
local getArgs      = require("script.core.hover.args")
local getHover     = require("script.core.hover")
local config       = require("script.config")
local util         = require("script.utility")
local markdown     = require("script.provider.markdown")
local parser       = require("script.parser")
local keyWordMap   = require("script.core.completion.keyword")
...
local postfix      = require("script.core.completion.postfix")
...
local autoRequire  = require("script.core.completion.auto-require")
